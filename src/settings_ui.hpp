...
class SettingsWindow {
  ...
  private:
    ...
    HWND add(const wchar_t *type, const wchar_t *text, DWORD style, int id, int page, int x, int y, int w,
             int h);
    ...
    void layout();
    void page();
    void change(bool persist = true);
    void presets();
    void save_preset();
    void load_preset();
    void choose_color(bool liquid);
};
} // namespace beer
